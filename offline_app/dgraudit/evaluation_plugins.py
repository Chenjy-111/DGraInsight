...
PLUGIN_INFO = {
    "dgraformer": {"model": "DGraFormer", "context": "window", "config": "profiles/dgraformer.json", "compatibility": "DGraFormerAdapter source layout and declared architecture/checkpoint; source hashes recorded on each run."},
    "msgnet": {"model": "MSGNet", "context": "scale", "config": "profiles/msgnet.json", "compatibility": "MSGNetAdapter source layout with corrected source/target semantics; internal graph positions are not output variables."},
    "mtgnn": {"model": "MTGNN", "context": "global_graph", "config": "profiles/mtgnn.json", "compatibility": "MTGNN single-step learned-graph configuration; shared adjacency and transpose branches; no broader-context operation."},
}
